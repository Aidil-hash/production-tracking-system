...
export default function LinePerformanceChart() {
  ...
  // Chart data mapping for each line
  ...
  // Handle adding new chart (line)
  const addChart = (line: any) => {
    setLinesData((prevState) => [...prevState, line]); // Add new line data to state
  };
    ...
    <Card>
      ...
      <CardContent>
        ...
        <div className="space-y-1 relative z-10 mb-4">
          ...
          <Select onChange={(e) => handleDepartmentSort(e.target.value)}>
        ...
        <div className="add-more">
          <button onClick={() => addChart(filteredLines[1])} className="btn-add-more hover:bg-gray-500 focus:bg-gray-500 cursor-pointer px-3 py-1 ">
            Add More
          </button>
        </div>
      </CardContent>
